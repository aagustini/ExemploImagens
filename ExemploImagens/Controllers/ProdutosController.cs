...
namespace ExemploImagens.Controllers
{
    public class ProdutosController : Controller
    {
        private readonly EFContext _context;

        public ProdutosController(EFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var produto = await _context.Produto.Include("Imagens")
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,Descricao")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,Descricao")] Produto produto)
        {
